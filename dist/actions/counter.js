...
exports.dispatchGetUserInfo = exports.getListData = exports.dispatchMyTest = undefined;

var _counter = require('../constants/counter.js');

var _list = require('../services/list.js');

var dispatchMyTest = exports.dispatchMyTest = function dispatchMyTest() {
  return function () {
...
var getListData = exports.getListData = function getListData() {
  var pageNo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
  var pageSize = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
  return function (dispatch) {
    console.log('getPositionsList：', _list.list);
    (0, _list.list)(pageNo, pageSize).then(function (res) {
      return new Promise(function (resolve, reject) {
        if (res) {
          dispatch({
            type: _counter.GET_LIST_DATA,
            positionsList: [{
              logger: {
                traceCapable: true,
...
var dispatchGetUserInfo = exports.dispatchGetUserInfo = function dispatchGetUserInfo() {
  return {
    type: _counter.GET_USER_INFOS
  };
};